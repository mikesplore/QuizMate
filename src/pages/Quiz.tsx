...
import { CheckCircle, XCircle, ChevronRight, ChevronLeft, TrendingUp, AlertTriangle } from 'lucide-react'
import { MultipleChoiceQuestion, TrueFalseQuestion, QuizAnswer } from '../types'
                ...
                {selectedAnswer === q.correct_answer ? (
                  <>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-700">Great job! Your answer is right.</p>
                    </div>
                  </>
                ) : (
                  <>
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex justify-between items-center">
        <button
          ...
          className="flex items-center space-x-2 px-6 py-3 bg-white border border-tertiary-white rounded-lg hover:bg-secondary-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
